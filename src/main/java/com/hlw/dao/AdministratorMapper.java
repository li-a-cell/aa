...
public interface AdministratorMapper {
    ...
    @Insert("INSERT INTO employee (account, name, job_type, salary, hire_date, phone_number, password, gender, birth_date, address) " +
            "VALUES (#{newEmployee.account}, #{newEmployee.name}, #{newEmployee.job_type}, #{newEmployee.salary}, #{newEmployee.hire_date}, #{newEmployee.phone_number}, #{newEmployee.password}, #{newEmployee.gender}, #{newEmployee.birth_date}, #{newEmployee.address})")
